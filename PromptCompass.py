                    ...
                    if input_values['prompt'] and input_values['user']:
                        ...
                        for key, user_input in enumerate(input_values['user']):
                            ...
                            for i in range(repeat_input):
                                ...
                                if model_id in ['gpt-3.5-turbo', 'gpt-3.5-turbo-16k', 'gpt-4-1106-preview', 'gpt-4', 'gpt-4-32k', 'gpt-3.5-turbo-instruct', 'babbage-002', 'davinci-002']:
                                    ...
                                    st.success("Input:  " + user_input + "  \n\n " +
                                               "Output: " + output)
                                elif model_id == "ehartford/dolphin-2.1-mistral-7b" or model_id == "lvkaokao/mistral-7b-finetuned-orca-dpo-v2" or model_id == "lmsys/vicuna-13b-v1.5" or model_id == "microsoft/Orca-2-13b" or model_id == "bigscience/bloomz-7b1"  or model_id == "bigscience/bloomz-7b1-mt":
                                    if pipe is None:
                                        with st.status('Loading model %s' % model_id) as status:
